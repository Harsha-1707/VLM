"""
Groq Vision (VLM) Gradio Chatbot
--------------------------------
Multimodal chat UI: users can attach an image + ask a question,
and get streamed responses from a Groq-hosted vision-language model.
...
Note: Groq's vision model lineup changes over time. As of writing, the
current recommended vision-capable model is "qwen/qwen3.6-27b" (preview).
"meta-llama/llama-4-scout-17b-16e-instruct" is also vision-capable.
Check https://console.groq.com/docs/vision for the latest options.
"""
...
load_dotenv()  # reads a .env file in the same folder, if present, into os.environ

# ---------------------------------------------------------------------
# Config
# ---------------------------------------------------------------------
MODEL = "qwen/qwen3.6-27b"          # vision-capable; swap for
                                     # "meta-llama/llama-4-scout-17b-16e-instruct" if preferred
SYSTEM_PROMPT = (
...
MAX_IMAGES_PER_TURN = 5             # Groq's current per-request limit
